	...
	\begin{itemize}
		...
		\item $\textcolor{e-color}{<} \subseteq \textcolor{e-color}{E} \times (V + E)$ and $\textcolor{closed-color}{<} \subseteq \textcolor{closed-color}{E} \times (V + E)$ with $\textcolor{e-color}{E}, \textcolor{closed-color}{E} \subset E$ are disjoint partial orders that are defined as a transitive closure of corresponding immediate predecessor relations that we denote as $\textcolor{e-color}{<^{\mu}}$ and $\textcolor{closed-color}{<^{\mu}}$.
		      ...
		      \begin{enumerate}
			      ...
			      \item the relations are closed under connectivity, \emph{i.e.}, if $v \in s(e)$ then $e' \textcolor{e-color}{<^{\mu}} e$ iff $e' \textcolor{e-color}{<^{\mu}} v$, similarly for $v \in t(e)$ and $\textcolor{closed-color}{<^{\mu}}$.
		      \end{enumerate}
