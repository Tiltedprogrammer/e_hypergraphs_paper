...
\textcolor{red}{The paragraph below may not be very relevant anymore considering slotted e-graphs where you can quite flexibly define the substitution (although rewiring is still a very simple concept)}
