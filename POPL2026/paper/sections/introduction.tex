...
Despite this, there are applications where the use of string diagrams may be more beneficial than that of (slotted) e-graphs, for example in the case of lambda calculus with explicit substitution that we will describe next.
