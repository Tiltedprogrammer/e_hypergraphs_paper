...
CHRIS: EXPLAIN THE CONDITIONS,  HOW WE WILL INTERPRET THE STRING DIAGRAMS.  WHAT DOES (4) FOR CONSISTENCY MEAN? 
...
In other words, homomorphism should preserve immediate predecessors and the conflict relation.  CHRIS: CHECK I DIDNT INTRODUCE MISTAKES ABOVE.  SHOULD WE USE $< ; \phi$ NOTATION TO MATCH OTHER HYPERGRAPH DEFINITION? 
