...
A concrete description of the pushout of two morphisms in this category is given in the Appendix~\ref{sec:appendix:pushout}.
...
Most importantly a pushout for the composition of two cospans with discrete feet always exists, as described below.
