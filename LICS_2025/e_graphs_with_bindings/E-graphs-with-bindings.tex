...
Revisiting the simple earlier example $\lambda f . f ((\lambda x . f x) 2)$, in Figure~\ref{fig:de-brujin-string}, observe that the two occurrences of $f$ are now shared.
