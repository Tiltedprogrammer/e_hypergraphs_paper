...
Further examples of isomorphic and non-isomorphic extended cospans can be found in Appendix~\ref{sec:appendix:iso}.
...
Examples and non-examples of a boundary complement can be found in Appendix~\ref{sec:appendix:iso}.
% \begin{remark}
...
An example of rewriting of extended cospans can be found in Appendix~\ref{sec:appendix:iso}.
