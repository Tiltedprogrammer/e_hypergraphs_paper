...
The motivating example of our work, e-graphs, requires the Cartesian structure to express arbitrary sharing as could be seen in Figure~\ref{fig:e-graph-example}.
