...
We will use enrichment to axiomatize the e-box (e-class) structure as the \enquote{join} of two morphisms $f,g: A \to B$ as $f + g: A \to B$. 
...
\begin{proposition}(A specialised case of Proposition 6.4.7~\cite{Borceux_1994} and Theorem 5.7.1~\cite{cruttwell2008normed}. See also \ifcameraready{Appendix~\ref{sec:appendix:slat}}{\cite{tiurin2025equivalencehypergraphsdporewriting}})
