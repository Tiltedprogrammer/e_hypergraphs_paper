...
\input{../LICS/sections/introduction}
\input{../LICS/sections/combinatorial_semantics}
\input{../LICS/sections/e-hypergraphs}
\input{../LICS/sections/soundness_and_completeness}
\input{../LICS/sections/conclusion}
