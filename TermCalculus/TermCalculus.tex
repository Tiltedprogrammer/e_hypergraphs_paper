...
We define a type theory for $\catname{SLat}$-enriched categories and show that the type theory has standard desirable syntactic properties such as admissibility and associativity of substitution.
We then show that the type theory correctly defines a free $\catname{SLat}$-enriched category.
Finally, we define a term rewriting on the type theory that can capture the equality saturation.

\section{Categorical semantics of e-graphs}
Recap of $\catname{SLat}$ categories.
...
\section{Soundness}
A theorem about type theory defining a free $\catname{SLat}$-enriched category.

\section{Term rewriting}
Formulate equality saturation in terms of a fixed point of term rewriting.
Not sure I can say more than that.
