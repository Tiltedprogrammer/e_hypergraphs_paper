...
\begin{figure}[t!]
    ...
    \end{subfigure}
    \caption{Slotted e-graph (a) and string diagram (b) repesentations of the same term.}
\end{figure}
...
The main technical result is the soundness and completeness of this combinatorial representation with respect to the class of morphisms it represents, and
...
\Cref{chapter:algebras} recalls the necessary background on algebraic theories provides an algebraic treatment of traditional e-graphs.
