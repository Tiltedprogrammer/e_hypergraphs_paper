...
\begin{definition}[Definition 2.17~\cite{bonchi_string_2022-1}]
...
\begin{definition}[Category $\catname{HypI}(\Sigma)$]
...
\begin{example}[Example 3.7~\cite{bonchi_string_2022-1}]
...
\[
\Sigma_{\text{Frob}} \defeq \{\adjustbox{scale=0.6}{\tikzfig{./figures/string/monoid_generator}} : 2 \to 1, \adjustbox{scale=0.6}{\tikzfig{./figures/string/unit_generator}} : 0 \to 1, \adjustbox{scale=0.6}{\tikzfig{./figures/string/comonoid_generator}} : 1 \to 2, \adjustbox{scale=0.6}{\tikzfig{./figures/string/counit_generator}} : 1 \to 0 \};
\]
...
\begin{gather*}
 [\adjustbox{scale=0.4}{\tikzfig{./figures/string/monoid_generator}}] \defeq \adjustbox{scale=0.8}{\tikzfig{./figures/string/monoid_interpretation}}~,
 ...
 [\adjustbox{scale=0.4}{\tikzfig{./figures/string/comonoid_generator}}] \defeq \adjustbox{scale=0.8}{\tikzfig{./figures/string/comonoid_interpretation}}~,
...
\begin{theorem}[Theorem 4.1~\cite{bonchi_string_2022-1}]\label{thm:frobenius_isomorphism}
...
\[
(m \xrightarrow{i} V_{\mathcal{G}} \xleftarrow{[\id, \tilde{j}]} V_{\mathcal{G}} \otimes \tilde{m}) \fatsemi (V_{\mathcal{G}} \otimes \tilde{m} \xrightarrow{\id \otimes \tilde{f}} V_{\mathcal{G}} \otimes \tilde{E} \xleftarrow{\id \otimes \tilde{g}} V_{\mathcal{G}} \otimes \tilde{n}) \fatsemi (V_{\mathcal{G}} \otimes \tilde{n} \xrightarrow{[\id, \tilde{i}]} V_{\mathcal{G}} \xleftarrow{i} \tilde{n})~.
\]
For example, below is a cospan (on the left) and its $\tilde{E}$ counterpart (on the right),
\[
\adjustbox{scale=0.8}{\tikzfig{./figures/string/piling_example_1}} \qquad \adjustbox{scale=0.8}{\tikzfig{./figures/string/piling_example_2}}~.
\]
