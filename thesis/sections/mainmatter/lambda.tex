...
Slotted e-graphs extend the traditional signature employed by e-graphs with an explicit construct for binding ($\text{bind}\; \$x\; tc$) and variables (\emph{slots}).
  ...
  The same restrictions apply as in the case of traditional e-graphs: if we were to draw a precise correspondence between string diagrams for $\catname{SLag}$-categories and slotted e-graphs, we would need to be careful about sharing and cycles.
