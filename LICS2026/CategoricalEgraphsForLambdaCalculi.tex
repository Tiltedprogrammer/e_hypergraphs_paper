...
\begin{abstract}
	...
	Our approach, specifically designed for lambda calculi, is compared and contrasted with slotted e-graphs — a recent, more generic method for incorporating variable binding within e-graphs.
\end{abstract}
