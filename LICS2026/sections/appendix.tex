...
\begin{proposition}[\autoref{prop:hypi_is_smc} restatement.]
...
\textcolor{red}{TODO: add examples}
...
\begin{table*}
	...
	\end{tabular}
	\caption{Number of e-nodes after saturating the e-graph for $2 + 2$ with different sets of rewrite rules from~\autoref{tbl:e-graph-subst-rules}}
	\label{tbl:slotted}
\end{table*}
...
\begin{table*}
	...
	\end{tabular}
	\caption{Number each rewrite rule was applied during saturation of the e-graph for $2 + 2$}
