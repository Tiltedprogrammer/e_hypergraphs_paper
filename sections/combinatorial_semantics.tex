        ...
        \item $[<_{c,X+Y}^{\mu}(e)]_{E} = <_{c,\sfrac{X+Y}{\sim}}^{\mu}([e]_{E})$ for $e$ such that $[e) \not = \varnothing$.
              ...
              \begin{itemize}
                \item $e$ has a pre-image $z$ in $E_{Z}$.
                    \begin{itemize}
                        \item If $[z) \not = \varnothing$.
                              Then, by definition, $<_{c,\sfrac{X+Y}{\sim}}^{\mu}([e]_{E}) = [<_{c,X+Y}^{\mu}(e)]_{E}$ which is what we need.
                        \item If $[z) = \varnothing$ and $[f_{E}(z)) = \varnothing$ and $[g_{E}(z)) \not = \varnothing$.
                              Because $i_{2,E}$ is a homomorphism, we have $<_{c,X+Y}^{\mu}(g_{E};i_{2,E}(z)) = i_{2,E}(<_{c,Y}^{\mu}(g_{E}(z))) = i_{2,E}(e_{y})$.
                              ...
                              \[
                              <_{c,\sfrac{X+Y}{\sim}}^{\mu}([e]) = [g_{E};<_{c,Y}^{\mu};i_{2,E}(z)]_{E} = [i_{2,E}(e_{y})]
                              \]
                              and
                              \begin{align*}
                                [<_{c,X+Y}^{\mu}(e)] = [<_{c,X+Y}^{\mu}(g_{E};i_{2,E}(z))] &= \\
                                &\text{because $[g_{E}(z)) \not = \varnothing$ and $i_{2,E}$ is homomorphism}\\
                                 = [i_{2,E}(<_{c,Y}(g_{E}(z)))] = [i_{2,E}(e_{y})]
                              \end{align*}
                              so we get
                              \[
                              <_{c,\sfrac{X+Y}{\sim}}^{\mu}([e]) = [<_{c,X+Y}^{\mu}(e)]
                              \]
